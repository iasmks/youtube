...
async function display(){
    ...
    let res = await fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&key=AIzaSyDsV6RK0dytl2VMbzzfwx8F-uM69r9qcLs&type=video&q&maxResults=50`);
...
//search for videos
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&type=video&key=AIzaSyDsV6RK0dytl2VMbzzfwx8F-uM69r9qcLs&maxResults=25`);
